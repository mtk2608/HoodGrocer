...
namespace HoodGrocer.Services
{
    public class HoodGrocerLocalDatabase 
    {
        ...
        public HoodGrocerLocalDatabase()
        {
            ...
            _dbConnection.CreateTable<CartProduct>();
        ...
        public void SeedDatabase()
        {
            ...
            if (_dbConnection.Table<Product>().Count() == 0)
            {
                ...
                _dbConnection.InsertAll(products);
        ...
        {
            return _dbConnection.Table<CartProduct>().ToList();
        }

        public void InsertToDatabase(CartProduct item)
        {
            _dbConnection.Insert(item);
        }

        public void RemoveFromCart(Product itemToRemove)
        {
